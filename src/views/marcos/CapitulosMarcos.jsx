...
import capitulosData from "../../data/capitulosMarcos.json";
import "../pages.css";
  ...
  return (
    <div className="page-container">
      <header className="page-header text-center">
        <h1 className="title-large">El Evangelio de Marcos</h1>
      ...
      <div className="features-grid">
        {capitulosData.map((cap) => (
          <Link
            href={`/marcos/capitulos/${cap.capitulo}`}
            key={cap.capitulo}
...
export function CapituloDetalle() {
  ...
  if (!capitulo) {
    return (
      <div className="page-container text-center mt-5">
        ...
        <button
          onClick={() => router.push("/marcos/capitulos")}
          style={{
            padding: "10px 20px",
            background: "var(--color-accent)",
            color: "white",
  ...
  return (
    <div className="page-container">
      ...
      >
        <h1 className="title-large">Marcos {capitulo.capitulo}</h1>
      ...
      >
        {capNum > 1 ? (
          <button
            onClick={() => router.push(`/marcos/capitulos/${capNum - 1}`)}
            style={{
              padding: "10px 20px",
              background: "white",
