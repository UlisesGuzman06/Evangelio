...
const navItems = [
  ...
  { path: "/hechos/capitulos", label: "Capítulos", icon: <FileText size={20} /> },
  { path: "/hechos/temas", label: "Temas Principales", icon: <Compass size={20} /> },
  { path: "/hechos/pasajes", label: "Pasajes Clave", icon: <Sunrise size={20} /> },
          ...
          <nav className="sidebar-nav">
            ...
            {navItems.map((item) => (
              <Link
                ...
                className={`nav-item ${
                  pathname === item.path ||
                  (item.path === "/hechos/capitulos" &&
                    pathname.startsWith("/hechos/capitulos"))
                    ? "active"
                    : ""
                }`}
                onClick={() => setSidebarOpen(false)}
